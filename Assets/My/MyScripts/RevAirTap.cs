...
public class RevAirTap : MonoBehaviour, IInputClickHandler
{
    ...
    public void OnInputClicked(InputClickedEventData eventData)
    {
        ...
        else if (setcanon == true)
        {
            ...
            cube.transform.position = Camera.main.transform.TransformPoint(0, 0, 1.3f);  //自分からみて前方1.2mの位置を空間内の位置に変換
        }
        else if (setfan == true)
        {
        ...
        else if (setstobj == true)
        {
            ...
            cube.transform.position = Camera.main.transform.TransformPoint(0, 0, 1.25f);  //自分からみて前方1.2mの位置を空間内の位置に変換
        }
